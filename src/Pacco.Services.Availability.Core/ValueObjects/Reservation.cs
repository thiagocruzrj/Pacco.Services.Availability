...
namespace Pacco.Services.Availability.Core.ValueObjects
{
    public struct Reservation : IEquatable<Reservation>
    {
        ...
        public bool Equals(Reservation other) => DateTime.Equals(other.DateTime) && Priority == other.Priority;

        public override bool Equals(object obj) => obj is Reservation other && Equals(other);
